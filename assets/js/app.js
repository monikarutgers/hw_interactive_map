...
d3.json(queryUrl, function(earthquakeData) {
  ...
  d3.json(queryUrl, function(QueryData) {
    // Once we get a response, send the data.features object to the createFeatures function
    var myStyle = {
      "color": "#FFAA00",
      "weight": 4,
    ...
    querylines = L.geoJson(QueryData.features, {
    style: myStyle});
    createMap(earthquakes, querylines);
  });
...
function createMap(earthquakes, querylines) {
